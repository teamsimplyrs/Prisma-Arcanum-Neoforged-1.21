...
public class NapalmSprayProjectile extends AbstractSpellProjectile {
    protected final Logger LOGGER = LogUtils.getLogger();

    public NapalmSprayProjectile(EntityType<? extends Projectile> type, Level level) {
        super(type, level);
        this.setNoGravity(false);
    }

    public NapalmSprayProjectile(LivingEntity shooter, Level level, ResourceLocation spellID) {
        super(PAEntityRegistry.NAPALM_SPRAY_PROJECTILE.get(), level);
