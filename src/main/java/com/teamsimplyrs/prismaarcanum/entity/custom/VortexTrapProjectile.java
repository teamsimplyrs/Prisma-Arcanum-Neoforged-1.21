...
public class VortexTrapProjectile extends AbstractSpellProjectile {
    public VortexTrapProjectile(EntityType<? extends Projectile> entityType, Level level) {
        super(entityType, level);
        setNoGravity(false);
    }

    public VortexTrapProjectile(LivingEntity shooter, Level level, ResourceLocation spellID) {
        super(PAEntityRegistry.VORTEX_TRAP_PROJECTILE.get(), level);
